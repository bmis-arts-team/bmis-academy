...
export const DEVOPS_ROUTES: Routes = [
  ...
  { path: 'manifestes-secrets-et-pvc', loadComponent: () => import('./lessons/lesson-19.component').then(m => m.Lesson19Component) },
  { path: 'ingress-https-et-gitops', loadComponent: () => import('./lessons/lesson-20.component').then(m => m.Lesson20Component) },
  { path: 'autoscaling-et-observabilite', loadComponent: () => import('./lessons/lesson-21.component').then(m => m.Lesson21Component) },
  { path: 'logging-centralise', loadComponent: () => import('./lessons/lesson-22.component').then(m => m.Lesson22Component) },
  { path: 'cicd-pipeline', loadComponent: () => import('./lessons/lesson-23.component').then(m => m.Lesson23Component) },
  { path: 'hardening-production', loadComponent: () => import('./lessons/lesson-24.component').then(m => m.Lesson24Component) },
];
